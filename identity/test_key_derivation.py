...
def test_key_derivation():
    ...
    mnemonic = Bip39MnemonicGenerator(Bip39Languages.ENGLISH).FromWordsNumber(12).ToStr()
    ...
    try:
        ...
        for i, user_address in enumerate(test_addresses, 1):
            ...
            try:
                ...
                results.append({"user_address": user_address, "derived_address": derived_address})
