...
class TestOperationsAPI:
    """Test cases for the operations API endpoints."""
    ...
    def test_cancel_operation_service_error(self):
        """Test operation cancellation when service raises exception."""
        operation_id = "test-prediction-id-123"
        
        with patch('api.operations.operations_service') as mock_service:
            # Configure mock to raise exception
            mock_service.cancel.side_effect = Exception("Service error")
    ...
    def test_get_operation_missing_id(self):
        """Test operation retrieval with missing operation ID."""
